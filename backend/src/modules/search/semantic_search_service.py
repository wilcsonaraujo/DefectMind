...
index_label = {
    ...
    "Requirement": "requirement_embedding_index",
    "TestCase": "testcase_embedding_index",
    "BugReport": "bugreport_embedding_index",
    "Incident": "incident_embedding_index",
    "PostMortem": "postmortem_embedding_index",
}


class SemanticSearchService:
    def __init__(self, neo4j_session, embedding_service: EmbeddingService):
