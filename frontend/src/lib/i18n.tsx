...
const dict: Dict = {
  ...
  "nav.qualityIntelligence": { pt: "Quality Intelligence", en: "Quality Intelligence" },
  "nav.qualityIntelligence.sub": { pt: "Análises com IA sobre o grafo", en: "AI-powered graph analysis" },
  ...
  // Quality Intelligence page
  "qi.title": { pt: "Quality Intelligence", en: "Quality Intelligence" },
  "qi.subtitle": { pt: "Análises de qualidade interpretadas por IA a partir do grafo", en: "AI-interpreted quality analysis from the graph" },
  "qi.tab.healthScore": { pt: "Health Score", en: "Health Score" },
  "qi.tab.hotspots": { pt: "Hotspots", en: "Hotspots" },
  "qi.tab.coverage": { pt: "Cobertura de Testes", en: "Test Coverage" },
  "qi.tab.knowledgeGaps": { pt: "Lacunas de Conhecimento", en: "Knowledge Gaps" },
  "qi.tab.releaseReadiness": { pt: "Prontidão de Release", en: "Release Readiness" },
  "qi.tab.riskReport": { pt: "Relatório de Risco", en: "Risk Report" },
  "qi.tab.recommendations": { pt: "Recomendações", en: "Recommendations" },
  "qi.nodeIdLabel": { pt: "ID do artefato (node_id)", en: "Artifact ID (node_id)" },
  "qi.nodeIdPlaceholder": { pt: "Ex: story-abc123 ou uuid…", en: "E.g: story-abc123 or uuid…" },
  "qi.analyze": { pt: "Analisar", en: "Analyze" },
  "qi.analyzing": { pt: "Analisando…", en: "Analyzing…" },
  "qi.selectArtifactPrompt": { pt: "Informe o ID de um artefato e clique em Analisar.", en: "Enter an artifact ID and click Analyze." },
  "qi.aiAnalysis": { pt: "Análise da IA", en: "AI Analysis" },
  "qi.recommendations": { pt: "Recomendações", en: "Recommendations" },
  "qi.noData": { pt: "Nenhum dado encontrado.", en: "No data found." },
  "qi.loadError": { pt: "Erro ao carregar dados", en: "Error loading data" },
  "qi.retry": { pt: "Tentar novamente", en: "Retry" },
  "qi.risk.low": { pt: "Baixo", en: "Low" },
  "qi.risk.medium": { pt: "Médio", en: "Medium" },
  "qi.risk.high": { pt: "Alto", en: "High" },
  "qi.verdict.ready": { pt: "Pronta", en: "Ready" },
  "qi.verdict.needsAttention": { pt: "Requer Atenção", en: "Needs Attention" },
  "qi.verdict.notReady": { pt: "Não Pronta", en: "Not Ready" },
  "qi.blockers": { pt: "Bloqueadores", en: "Blockers" },
  "qi.selectStories": { pt: "Selecione as Stories", en: "Select the Stories" },
  "qi.searchStoriesPlaceholder": { pt: "Buscar Stories por nome…", en: "Search Stories by name…" },
  "qi.noStoriesSelected": { pt: "Selecione ao menos uma Story para avaliar.", en: "Select at least one Story to evaluate." },
  "qi.storiesSelectedSuffix": { pt: "Stories selecionadas", en: "Stories selected" },
  "qi.coverageScore": { pt: "Cobertura", en: "Coverage" },
  "qi.healthRisk": { pt: "Risco de Saúde", en: "Health Risk" },
  "qi.incidentsWithoutPostmortem": { pt: "Incidentes sem postmortem", en: "Incidents without postmortem" },
  "qi.total": { pt: "Total", en: "Total" },
